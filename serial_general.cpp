...
void obtain_huffmancodes(node* root, string current, unordered_map<int,string>& encode)
{
...
int main()
{
    string filename = "tttest.raw";
    string compressed_file_name = "ttest_file_compressed.raw";
    string decompressed_file_name = "ttestop.raw";
